...
use rest_api::handlers::legal::{legal_mentions, legal_privacy, legal_terms};
...
use rest_api::jobs::scheduler::start_scheduler;
...
async fn main() -> anyhow::Result<()> {
    ...
    start_scheduler(db, email_service_for_cron).await?;
